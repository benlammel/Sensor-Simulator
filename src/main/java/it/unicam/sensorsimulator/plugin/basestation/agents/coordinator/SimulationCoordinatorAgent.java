package it.unicam.sensorsimulator.plugin.basestation.agents.coordinator;
...
import it.unicam.sensorsimulator.plugin.basestation.agents.coordinator.behaviours.TriggerAssociationBehaviour;
...
public class SimulationCoordinatorAgent extends Agent implements SimulationCoordinatorAgentInterface {
	...
	protected void setup(){
		...
		try {
			...
			loadAgents();
			startAgents();
			addBehaviour(new TriggerAssociationBehaviour(this));
